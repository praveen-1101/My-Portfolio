...
const projects = [
  {
    ...
    liveUrl: "https://resume-analyzer-frontend-eight.vercel.app/",
    githubUrl: "https://github.com/praveen-1101/Resume-Analyzer",
  ...
  },
  {
    ...
    liveUrl: "https://flowtodest.vercel.app/",
    githubUrl: "https://github.com/praveen-1101/trip-plan",
  ...
  },
  {
    ...
    liveUrl: "https://vignan-feedback-web.vercel.app/",
    githubUrl: "https://github.com/praveen-1101/Academic-Details",
    image: "https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=800",
    featured: false,
    stats: {
      reviews: "100",
      subjects: "Flexible to add"
    }
  }
]
        ...
        <div className="space-y-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="overflow-hidden hover:shadow-2xl transition-all duration-500 border-border/50 bg-card/80 backdrop-blur-sm group lg:flex">
                {/* Image Section */}
                <div className="relative overflow-hidden w-full lg:w-1/2 h-full min-h-[260px] max-h-[440px] flex-shrink-0">
                  <img
                    src={project.image}
                    alt={project.title}
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                    style={{ minHeight: '260px', maxHeight: '440px', height: '100%' }}
                  />
                ...
                {/* Content Section */}
                <div className="p-6 lg:p-8 flex flex-col justify-between h-full w-full">
                  <div className="space-y-6">
                    ...
                    <div className="flex gap-3 pt-4">
                      ...
                      >
                        <Button
                          variant="myellow"
                          className="w-full group relative overflow-hidden border-0 rounded-xl transition-all duration-500 hover:scale-105 hover:shadow-xl"
                        >
                      ...
                      >
                        <Button
                          variant="outline"
                          className="w-full group relative overflow-hidden border-2 border-myellow/30 dark:border-myellow/60 bg-white/80 dark:bg-black/80 backdrop-blur-sm hover:bg-myellow/10 dark:hover:bg-myellow/10 transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-myellow/10 rounded-xl hover:border-myellow dark:hover:border-myellow"
                        >
